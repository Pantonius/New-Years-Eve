...
var Particle = /*#__PURE__*/function () {
  ...
  _createClass(Particle, [{
    ...
    value: function show() {
      if (this.lifespan != -1) {
        var a = this.color.a - this.color.a * (this.deltaTime / this.lifespan);
    ...
    key: "colorVal",
    value: function colorVal(r, g, b, a) {
      this.color.r = r;
      this.color.g = g;
      this.color.b = b;
      this.color.a = a;
    ...
    key: "colorMode",
    value: function colorMode(_colorMode) {
      this.color.colorMode = _colorMode;
    }
  }, {
    key: "expired",
    ...
    value: function applyForce(force) {
      var f = new Vector().mult(force, this.mass);
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","canvas/particle.js"], null)
//# sourceMappingURL=/particle.f6bb273d.js.map